...
const AddMemorial = () => {
  ...
  return (
    <>
      <PageHeader title="Your Loved One" />
      <form action="#" className="memorial-form">
        ...
        <div className="form-group">
          ...
          <select id="birthmonth" onChange={handleInputChange} name='birthMonth'>
          ...
          <select id="birthday" onChange={handleInputChange} name='birthDay'>
          ...
          <select id="birthyear" onChange={handleInputChange} name='birthYear'>
        ...
        <div className="form-group">
          <label for="deathplace">Last Residence:</label>
          <input id="deathplace" type="text" placeholder="Mount Vernon" required onChange={handleInputChange} name='deathPlace'></input>
          <label for="deathstate">State:</label>
          <select id="deathstate" onChange={handleInputChange} name='deathState'>
            <option value="AL">Alabama</option>
            <option value="AK">Alaska</option>
            <option value="AZ">Arizona</option>
            <option value="AR">Arkansas</option>
        ...
        <div className="form-group">
          <label for="deathmonth">Date of Passing:</label>
          <select id="deathmonth" onChange={handleInputChange} name='deathMonth'>
            <option value="January">January</option>
            <option value="Febuary">Febuary</option>
            <option value="March">March</option>
            <option value="April">April</option>
          ...
          <select id="deathday" onChange={handleInputChange} name='deathDay'>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
            <option value="4">4</option>
          ...
          <select id="deathyear" onChange={handleInputChange} name='deathYear'>
            <option value="2020">2020</option>
            <option value="2019">2019</option>
            <option value="2018">2018</option>
            <option value="2017">2017</option>
